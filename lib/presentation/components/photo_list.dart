...
class PhotoList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return photos.photo.isNotEmpty ? ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          title: photo.title.isNotEmpty
              ? photo.title.toWidget()  // Display the photo title if available.
              : AppText.titleNotFound.toWidget(),  // Display a default text if title is not available.
